...
// Leaner CSS imports (Removed unused effect-fade)
import 'swiper/css';
...
const TestimonialCard = memo(({ testimonial }) => {
  ...
  return (
    <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 p-4 sm:p-6 lg:p-8 xl:p-10 mx-1 sm:mx-2 group hover:-translate-y-2 border border-gray-100 transform-gpu">
      {/* Quote Icon */}
      <div className="text-yellow-custom/20 text-4xl sm:text-5xl lg:text-6xl font-serif mb-2 sm:mb-3 lg:mb-4 leading-none select-none">"</div>
      ...
      <div className="flex justify-start mb-3 sm:mb-4 lg:mb-6">
        {stars.map((_, i) => (
          <span 
            key={i} 
            className="text-yellow-custom text-base sm:text-lg lg:text-xl mr-1 transform group-hover:scale-110 transition-transform duration-300 will-change-transform" 
        ...
        <div className="relative">
          {testimonial.image ? (
            ...
            <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 xl:w-20 xl:h-20 rounded-full bg-yellow-custom border-4 border-yellow-custom/20 shadow-lg group-hover:border-yellow-custom/40 transition-all duration-300 flex items-center justify-center">
              <span className="text-white text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold select-none">
      ...
      <div className="container mx-auto relative z-10 px-4 sm:px-6">
        <div className="text-center mb-8 sm:mb-10 lg:mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 mt-2 px-4">
            {content?.subtitle || 'We are proud to be a home away from home.'}
          </p>
        ...
        <div className="w-full">
          ...
          >
            {testimonials.map((testimonial, index) => (
              // Using a stable key. Prefer testimonial.id if available in your data.
          ...
          <div className="flex justify-center items-center mt-8 gap-4">
            <button 
              className="testimonial-prev w-10 h-10 bg-white hover:bg-yellow-custom text-gray-600 hover:text-white rounded-full shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center will-change-transform"
            ...
            <button 
              className="testimonial-next w-10 h-10 bg-white hover:bg-yellow-custom text-gray-600 hover:text-white rounded-full shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center will-change-transform"
