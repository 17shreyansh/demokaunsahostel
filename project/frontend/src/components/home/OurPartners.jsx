  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="bg-white rounded-2xl py-4 px-4 shadow-sm overflow-hidden">
            <div className="partners-scroll flex select-none">
              {[...partners, ...partners].map((partner, index) => (
                <div key={`${partner.id}-${index}`} className="flex-shrink-0 mx-8 sm:mx-12">
        ...
        <div className="absolute top-10 left-10 w-4 h-4 bg-gradient-to-br from-yellow-custom to-orange-400 rounded-full opacity-30"></div>
        <div className="absolute bottom-10 right-10 w-6 h-6 bg-gradient-to-br from-yellow-400 to-yellow-custom rounded-full opacity-20"></div>
      </div>
    </section>
  )
}
