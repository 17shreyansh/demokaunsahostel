        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center lg:h-full">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-12 justify-center lg:justify-start">
              <Link to={content?.primaryButton?.link || '/hostels'} className="group bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 font-semibold px-8 py-4 rounded-2xl hover:shadow-2xl hover:shadow-yellow-200 transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center will-change-transform">
                <svg className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
                {content?.primaryButton?.text || 'Explore Hostels'}
              </Link>
              <a href={content?.secondaryButton?.link || 'tel:+919876543210'} className="group bg-white text-gray-700 font-semibold px-8 py-4 rounded-2xl border-2 border-gray-200 hover:border-yellow-300 hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center will-change-transform">
                <svg className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
