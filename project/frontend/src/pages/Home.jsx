  ...
  return (
    <main className="relative">
      ...
      <div className="fixed top-0 left-0 w-full h-screen bg-gradient-to-br from-blue-50 via-white to-yellow-50 overflow-hidden pointer-events-none" style={{ zIndex: -1 }}>
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 w-[600px] h-[600px] bg-gradient-to-r from-yellow-100 to-yellow-100 rounded-full opacity-10 blur-3xl transform -translate-x-1/2 -translate-y-1/2"
        />
        <div
          className="absolute top-32 left-1/4 w-16 h-16 bg-gradient-to-br from-yellow-300 to-yellow-300 rounded-2xl opacity-30 blur-sm"
        />
        <div
